...
# BASE_DIR should be defined as follows
...
SECRET_KEY = "django-insecure-&u8+w039nmm=bmwsbxk@tchj0gomnsv)xmf=shkl-pks+*&u3("
...
# Django-Heroku settings (must be at the end)
